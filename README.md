...
This table lists the configuration variables required to operate AWS GuardDuty. These variables are specified when configuring a GuardDuty asset in Splunk SOAR.
