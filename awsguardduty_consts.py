...
AWSGUARDDUTY_MAX_PAGINATION_ITEMS = AWSGUARDDUTY_MAX_PER_PAGE_LIMIT * AWSGUARDDUTY_MAX_PAGINATION_PAGES
AWSGUARDDUTY_CHECKPOINT_VERSION = 2
AWSGUARDDUTY_CHECKPOINT_OVERLAP_MS = 1000
